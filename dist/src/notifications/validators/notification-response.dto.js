...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Inscription confirmée ✅' }),
    __metadata("design:type", String)
], NotificationResponseDto.prototype, "title", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Tu es inscrit au tournoi "FIRE STORM CUP #18" — Slot #3' }),
    __metadata("design:type", String)
], NotificationResponseDto.prototype, "body", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ enum: ['INFO', 'SUCCESS', 'WARNING', 'DANGER'], example: 'SUCCESS' }),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: '2026-03-04T20:00:00.000Z' }),
